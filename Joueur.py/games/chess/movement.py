...
def next_move(board_list: GameState, move, is_white):
    ...
    if is_castling(board_list, move_coords, is_white):
        # Fix castling
        pass 
    ...
    # If white and move white rook then set false for castle
        if board_list.white_castle_king and move_coords[0] == 0 and move_coords[1] == 7:
            new_board.white_castle_king = False
        if board_list.white_castle_queen and move_coords[0] == 0 and move_coords[1] == 0:
            new_board.white_castle_queen = False
        if move_coords[0] == 0 and move_coords[1] == 4:
            new_board.white_castle_king = False
            new_board.white_castle_queen = False

    else:
    # if black ... 
        if board_list.black_castle_king and move_coords[0] == 7 and move_coords[1] == 7:
            new_board.black_castle_king = False
        if board_list.black_castle_queen and move_coords[0] == 7 and move_coords[1] == 0:
            new_board.black_castle_queen = False
        if move_coords[0] == 7 and move_coords[1] == 4:
            new_board.black_castle_king = False
            new_board.black_castle_queen = False
...
#def print_chess(chess_board: GameState):
#    count = 9
#    for i in range(len(chess_board.board) - 1, -1, -1):
#        count -= 1
#        print(count, chess_board.board[i])
#    print(" ", CHESS_RANK)